    ...
    if (step === 1) {
        return (
            <div className="min-h-screen bg-[#020617] text-white flex flex-col items-center justify-center p-6 lg:p-12 overflow-hidden relative">
                ...
                <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="absolute top-12 flex items-center gap-3">
                ...
                <div className="w-full max-w-2xl relative z-10">
                    <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-slate-900/50 border border-white/10 backdrop-blur-xl rounded-[3rem] p-12 shadow-2xl">
                        ...
                        <form onSubmit={handleRegister} className="space-y-8">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    {/* Host dropdown */}
                                    {hosts.length > 0 && (
                                        <div className="absolute z-10 top-full left-0 right-0 mt-2 bg-slate-900 border border-white/10 rounded-xl overflow-hidden">
        ...
        <div className="min-h-screen bg-[#020617] text-white flex flex-col items-center justify-center p-6 lg:p-12 overflow-hidden relative">
            ...
            <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
                <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
                    ...
                    <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }}>
                        <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-tight mb-6">
                            ...
                            <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 to-indigo-400">{t('checkInComplete').split(' ')[1]}.</span>
                        </h1>
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }} className="mt-12 flex flex-col gap-6 w-full">
                ...
                <div className="flex flex-col items-center">
                    <motion.div initial={{ opacity: 0, scale: 0.9, rotate: -5 }} animate={{ opacity: 1, scale: 1, rotate: 0 }} transition={{ delay: 0.4, type: "spring" }} className="relative group w-full max-w-sm">
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.2 }} className="mt-16 w-full max-w-sm">
                        <button onClick={() => setStep(1)} className="w-full h-20 bg-white hover:bg-slate-100 text-slate-900 rounded-3xl font-black text-xl flex items-center justify-between px-8 group transition-all relative overflow-hidden active:scale-95">
                            <motion.div initial={{ width: "100%" }} animate={{ width: 0 }} transition={{ duration: 15, ease: "linear" }} className="absolute bottom-0 left-0 h-1 bg-blue-600/20 w-full" />
                            <span className="flex items-center gap-3"><CheckCircle size={28} className="text-blue-600" />{t('done')}</span>
