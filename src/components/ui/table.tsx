...
>(({ className, ...props }, ref) => (
    <thead
        ref={ref}
        className={cn("[&_tr]:border-b border-slate-200 bg-slate-50/50 ", className)}
        {...props}
    />
))
...
>(({ className, ...props }, ref) => (
    <tr
        ref={ref}
        className={cn(
            "border-b border-slate-100 transition-colors hover:bg-slate-50/80 data-[state=selected]:bg-orange-50 ",
            className
        )}
        {...props}
    />
