...
>(({ className, children, ...props }, ref) => (
    <DialogPortal>
        ...
        >
            {children}
            <DialogClose className="absolute right-4 top-4 rounded-lg opacity-70 ring-offset-white dark:ring-offset-slate-900 transition-all hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-slate-100 dark:data-[state=open]:bg-slate-800 data-[state=open]:text-slate-500 dark:data-[state=open]:text-slate-400 p-1 hover:bg-slate-50 dark:hover:bg-slate-800">
